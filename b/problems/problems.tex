...
\begin{center}
	\begin{tabular}{|c|c|c|}
		...
		\hline 6,7&$\le10^6$&$\le2$\\
		\hline 8,9,10&$\le10^6$&$\le10^9$\\
		\hline
	\end{tabular}
\end{center}
对于100\%的数据,有$1\le n\le 10^6,1\le v_i\le 10^9$
\newpage
\section{归程}
\subsection{题目背景}
...
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		\hline 6,7&$\le10^6$&$=n-1$&1号点向$2\sim n$号点各连一条边\\
		\hline 8,9,10&$\le10^6$&$\le2\times10^6$&无\\
		\hline
	\end{tabular}
\end{center}
对于100\%的数据，有$1\le n\le 10^6,1\le m\le 2\times10^6,1\le w\le 10,-10\le l\le 10$,保证图为有向无环图,且图内无重边,自环
\subsection{提示}
